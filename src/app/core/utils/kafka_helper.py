...
#C:\Users\santo\Documents\DevOps\DAQ_SIMULATION\test-serverless-upload-s3\FastAPI-boilerplate\src\app\core\utils\kafka.py
...
def serialize_array(arr: np.ndarray) -> bytes: # for kafka, we need to put the waveform into a byte string
    """
